...
| [Employee Analytics AI Agent](https://github.com/dannyxia7/Employee_Analytics_AI_Agent) | AI Agents, Data Analysis, Data Engineering | An end-to-end AI agent that cleans HR datasets and uses LLMs to answer complex natural language queries regarding salary, performance, and tenure. | `Python`, `FastAPI`, `Vertex AI`, `Pandas` |
